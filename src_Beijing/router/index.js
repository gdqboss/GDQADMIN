...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'bi', name: 'BiDashboard', component: lazyLoad(() => import('../views/bi/BiDashboard.vue')), meta: { title: 'BI分析', icon: 'chart' } },
      
      { path: 'profile', name: 'Profile', component: lazyLoad(() => import('../views/ProfileNew.vue')), meta: { title: '个人设置', title_en: 'My Profile', icon: 'person' } },
      ...
      { path: 'images', name: 'ImageLibrary', component: lazyLoad(() => import('../views/images/ImageLibrary.vue')), meta: { title: '图片库' } },
      { path: 'excel-analyzer', name: 'ExcelAnalyzer', component: lazyLoad(() => import('../views/bi/ExcelAnalyzer.vue')), meta: { title: '报表分析', title_en: 'Report Analysis', icon: 'file', roles: ['admin', 'manager', 'warehouse'] } },
      { path: 'excel-report-manage', name: 'ExcelReportManage', component: lazyLoad(() => import('../views/bi/ExcelReportManage.vue')), meta: { title: '报告管理', title_en: 'Report Management', icon: 'chart', roles: ['admin', 'manager', 'warehouse'] } },
      { path: 'excel-merge-view', name: 'ExcelMergeView', component: lazyLoad(() => import('../views/bi/ExcelMergeView.vue')), meta: { title: '合并报告详情', title_en: 'Merge Detail', icon: 'link', roles: ['admin', 'manager', 'warehouse'] } },
      ...
      { path: "settings/openclaw", name: "OpenClawAssistant", component: lazyLoad(() => import("../views/openclaw/OpenClawAssistant.vue")), meta: { title: "OpenClaw助手", roles: ["admin"] } },
