<template>
  <MinipLayout title="个人中心" :canBack="true" tabbar="me">
    ...
    <div class="settings-list">
      <div class="settings-row" @click="uni.navigateTo({ url: '/minip/misc/feedback' })">
        <span>💬</span><span class="label">意见反馈</span><span class="arrow">›</span>
      </div>
      <div class="settings-row" @click="uni.navigateTo({ url: '/minip/misc/about' })">
...
async function logout() {
  if (confirm('确定退出登录？')) {
    uni.removeStorageSync('caimeite_token')
    uni.removeStorageSync('caimeite_user')
