<template>
  <MinipLayout title="企业服务" :canBack="true" tabbar="enterprise">
    ...
    <div class="grid">
      <navigator url="/minip/finance" class="grid-cell">
        <div class="grid-icon" style="background:#dbeafe">💰</div>
        <span>财务</span>
      </navigator>
      <navigator url="/minip/hr" class="grid-cell">
        <div class="grid-icon" style="background:#dcfce7">👥</div>
        <span>人力</span>
      </navigator>
      <navigator url="/minip/oa" class="grid-cell">
        <div class="grid-icon" style="background:#fef3c7">📋</div>
        <span>OA</span>
      </navigator>
      <navigator url="/minip/marketing" class="grid-cell">
