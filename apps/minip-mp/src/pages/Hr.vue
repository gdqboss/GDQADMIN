<template>
  <MinipLayout title="人力中心" :canBack="true" tabbar="enterprise">
    ...
    <div class="grid">
      <navigator url="/minip/hr/directory" class="cell">
        <div class="cell-icon" style="background:#dbeafe">👥</div>
        <span>员工名册</span>
      </navigator>
      <navigator url="/minip/hr/attendance" class="cell">
        <div class="cell-icon" style="background:#dcfce7">⏰</div>
        <span>考勤打卡</span>
      </navigator>
      <navigator url="/minip/hr/salary" class="cell">
        <div class="cell-icon" style="background:#fef3c7">💰</div>
        <span>薪酬管理</span>
      </navigator>
      <navigator url="/minip/hr/leave" class="cell">
