...
<html>
<head>
<title>PigCms售后技术维护系统－重命名</title>
<style type="text/css">
...
if($_POST['name']!=null) {
echo <<<HTML
<div class="big_board"><div class="board_title">PigCms售后技术维护系统－命名结果</div></div>
HTML;
...
echo <<<HTML
<div class="big_board"><div class="board_title">PigCms售后技术维护系统－新的名称</div></div>
HTML;
echo <<<HTML
