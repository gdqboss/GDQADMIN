...
<html>
<head>
<title>PigCms售后技术维护系统－远程上传</title>
<style type="text/css">
...
<div class="big_board"><div class="board_title">PigCms售后技术维护系统－文件地址</div></div>
<input type="text" name="furl"/>
<div class="big_board"><div class="board_title">PigCms售后技术维护系统－存档名称</div></div>
