...
<html>
<head>
<title>PigCms售后技术维护系统－压缩数据</title>
<style type="text/css">
...
echo <<<HTML
<div class="big_board"><div class="board_title">PigCms售后技术维护系统－系统警告</div></div>
Hello,待处理文件为空!
HTML;
} elseif(preg_match('/^([a-zA-Z0-9_\-\.\x{4e00}-\x{9fa5}]+)([zip])$/iu',$_REQUEST['pkname'])==false) {
echo '<div class="big_board"><div class="board_title">PigCms售后技术维护系统－系统警告</div></div>Hello,存档名称不规范喔!';
} else {
$i=0;
