...
<html>
<head>
<title>PigCms售后技术维护系统－新建目录</title>
<style type="text/css">
...
echo <<<HTML
<div class="big_board"><div class="board_title">PigCms售后技术维护系统－系统提示</div></div>
HTML;
...
echo <<<HTML
<div class="big_board"><div class="board_title">PigCms售后技术维护系统－目录名称</div></div>
HTML;
