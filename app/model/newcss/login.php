...
<html>
<head>
<title>PigCms售后技术维护系统－用户模块</title>
<style type="text/css">
...
<body>
<div class="big_board"><div class="board_title">PigCms售后技术维护系统－用户模块</div></div>
HTML;
...
<input type="submit" value="登录PigCms售后技术维护系统"/>
</form>
HTML;
} else {
...
echo "-&gt;&gt;<a href=\"index.php\">PigCms售后技术维护系统首页</a>";
}
} else {
echo 'Hello,请不要非法闯入喔!';
}
