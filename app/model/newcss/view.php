...
<body>
<div class="big_board"><div class="board_title">PigCms售后技术维护系统－路径信息</div></div>
HTML;
echo '<a href="index.php?path='._encode(dirname(_decode($_GET['path']))).'">'.dirname(_decode($_GET['path'])).'</a>/'.basename(_decode($_GET['path']));
if($_GET['read']==null) {
echo '<div class="big_board"><div class="board_title">PigCms售后技术维护系统－分页查看</div></div>';
$page=new page();
$page->setsize(777);
...
echo '<div class="big_board"><div class="board_title">PigCms售后技术维护系统－页面导航</div></div>';
...
echo '<div class="big_board"><div class="board_title">PigCms售后技术维护系统－快捷跳转</div></div>';
echo <<<HTML
...
<div class="big_board"><div class="board_title">PigCms售后技术维护系统－编码设置</div></div>
<form action="{$_SERVER['PHP_SELF']}" method="get">
...
echo <<<HTML
<div class="big_board"><div class="board_title">PigCms售后技术维护系统－全文查看</div></div>
HTML;
$iread=file_get_contents(_decode($_GET['path']));
$iread=str_replace(array('&','<','>'),array('&amp;','&lt;','&gt;'),$iread);
echo nl2br($iread);
echo <<<HTML
<div class="big_board"><div class="board_title">PigCms售后技术维护系统－快捷按钮</div></div>
...
echo <<<HTML
<div class="big_board"><div class="board_title">www.pigcms.com</div></div>
HTML;
?>