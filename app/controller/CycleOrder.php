...
//订单详情
	...
	public function closeOrder(){
		...
		// 只更新collage_product表的sales字段，不更新stock字段，因为stock字段已移至collage_guige表
		Db::name('collage_product')->where('aid',aid)->where('bid',bid)->where('id',$order['proid'])->update(['sales'=>Db::raw("sales-".$order['num'])]);
		//优惠券抵扣的返还
