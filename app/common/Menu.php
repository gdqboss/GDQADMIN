...
class Menu
{
	...
	public static function getdata($aid=0,$uid=0,$ismenu=false){
       ...
       if(getcustom('business_withdraw')){
		...
		$menudata['shop'] = ['name'=>t('商城'),'fullname'=>t('商城系统'),'icon'=>'my-icon my-icon-shop','child'=>$shop_child];

        if($isadmin){
            $component_business = [];
            $component_business[] = ['name'=>t('商户列表'),'path'=>'Business/index','authdata'=>'Business/*,BusinessFreight/*'];
            $component_business[] = ['name'=>t('商户分类'),'path'=>'Business/category','authdata'=>'Business/*'];
            $component_business[] = ['name'=>t('商户商品'),'path'=>'ShopProduct/index&showtype=2','authdata'=>'ShopProduct/*'];
            $component_business[] = ['name'=>t('商户销量'),'path'=>'Business/sales','authdata'=>'Business/*'];
            $component_business[] = ['name'=>t('商户订单'),'path'=>'ShopOrder/index&showtype=2','authdata'=>'ShopOrder/*'];
            $component_business[] = ['name'=>t('商户评价'),'path'=>'BusinessComment/index&showtype=2','authdata'=>'BusinessComment/*'];
            $component_business[] = ['name'=>t('拼团商品'),'path'=>'CollageProduct/index&showtype=2','authdata'=>'CollageProduct/*'];
            $component_business[] = ['name'=>t('砍价商品'),'path'=>'KanjiaProduct/index&showtype=2','authdata'=>'KanjiaProduct/*'];
            $component_business[] = ['name'=>t('秒杀商品'),'path'=>'SeckillProduct/index&showtype=2','authdata'=>'SeckillProduct/*'];
            $component_business[] = ['name'=>t('团购商品'),'path'=>'TuangouProduct/index&showtype=2','authdata'=>'TuangouProduct/*'];
            $component_business[] = ['name'=>t('服务商品'),'path'=>'YuyueList/index&showtype=2','authdata'=>'YuyueList/*'];
            $component_business[] = ['name'=>t('周期购商品'),'path'=>'CycleProduct/index&showtype=2','authdata'=>'CycleProduct/*'];
            $component_business[] = ['name'=>t('幸运拼团商品'),'path'=>'LuckyCollageProduct/index&showtype=2','authdata'=>'LuckyCollageProduct/*'];
            ...
            $menudata['business'] = ['name'=>t('商户'),'fullname'=>t('多商户'),'icon'=>'my-icon my-icon-shop','child'=>$component_business];
        }else{
            }
        ...
        $menudata['finance'] = ['name'=>t('财务'),'fullname'=>t('财务管理'),'icon'=>'my-icon my-icon-finance','child'=>$finance_child];
        ...
        $menudata['yingxiao'] = ['name'=>t('营销'),'fullname'=>t('营销活动'),'icon'=>'my-icon my-icon-yingxiao','child'=>$yingxiao_child];
        $component_article = [];
		...
		$component_child[] = ['name'=>t('预约服务'),'child'=>$component_yuyue];
		...
		$component_child[] = ['name'=>t('知识付费'),'child'=>$component_kecheng];
		...
		if($isadmin){
            ...
            if(getcustom('express_maiyatian')){
				...
				$component_peisong[] = ['name'=>'配送单列表','path'=>'PeisongOrder/index','authdata'=>'PeisongOrder/*'];
                $component_peisong[] = ['name'=>'麦芽田设置','path'=>'Peisong/mytset','authdata'=>'Peisong/*'];
                $component_child[] = ['name'=>t('同城配送'),'child'=>$component_peisong];
            }
        }
...
//            $car_hailing_child[] = ['name'=>'约车评价','path'=>'CarHailingComment/index','authdata'=>'CarHailingComment/*'];
            ...
            $menudata['carhailing'] = ['name'=>t('约车'),'fullname'=>t('约车管理'),'icon'=>'my-icon my-icon-kuozhan','child'=>$car_hailing_child];
        }
        ...
        $component_child[] = ['name'=>t('收银台'),'child'=>$cashier_child];
...
$barcode_inventory_child[] = ['name' => t('库存列表'), 'path' => 'BarcodeInventory/index', 'authdata' => 'BarcodeInventory/*'];
$barcode_inventory_child[] = ['name' => t('新增商品'), 'path' => 'BarcodeInventory/edit', 'authdata' => 'BarcodeInventory/*'];
$barcode_inventory_child[] = ['name' => t('出库管理'), 'path' => 'BarcodeInventory/outbound', 'authdata' => 'BarcodeInventory/*'];
$barcode_inventory_child[] = ['name' => t('出库记录'), 'path' => 'BarcodeInventory/outbound_log', 'authdata' => 'BarcodeInventory/*'];
$barcode_inventory_child[] = ['name' => t('库存盘点'), 'path' => 'BarcodeInventory/check', 'authdata' => 'BarcodeInventory/*'];
$barcode_inventory_child[] = ['name' => t('库存报表'), 'path' => 'BarcodeInventory/report', 'authdata' => 'BarcodeInventory/*'];
$barcode_inventory_child[] = ['name' => t('打印报表'), 'path' => 'BarcodeInventory/print_report', 'authdata' => 'BarcodeInventory/*'];
$barcode_inventory_child[] = ['name' => t('系统设置'), 'path' => 'BarcodeInventory/settings', 'authdata' => 'BarcodeInventory/*'];
$menudata['barcode_inventory'] = ['name' => t('仓库'), 'fullname' => t('仓库管理'), 'icon' => 'my-icon my-icon-kuozhan', 'child' => $barcode_inventory_child];
