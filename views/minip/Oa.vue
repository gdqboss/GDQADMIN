<template>
  <MinipLayout title="OA 中心" :canBack="true" tabbar="enterprise">
    ...
    <div class="grid">
      <router-link to="/minip/oa/approval" class="cell">
        <div class="cell-icon" style="background:#dbeafe">📋</div>
        <span>审批</span>
      </router-link>
      <router-link to="/minip/oa/schedule" class="cell">
        <div class="cell-icon" style="background:#dcfce7">📅</div>
        <span>排班</span>
      </router-link>
      <router-link to="/minip/oa/meeting" class="cell">
        <div class="cell-icon" style="background:#fef3c7">🏢</div>
        <span>会议</span>
      </router-link>
      <router-link to="/minip/oa/workflow" class="cell">
