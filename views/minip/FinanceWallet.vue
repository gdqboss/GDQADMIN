...
onMounted(async () => {
  ...
  try {
    ...
    transactions.value = [
      { id: 1, title: '充值', time: '07-10 14:30', amount: 10000, type: 'in' },
      { id: 2, title: '报销支出', time: '07-09 09:12', amount: 1280, type: 'out' },
      { id: 3, title: '订单收款', time: '07-08 18:45', amount: 5600, type: 'in' }
    ]
  }
})
</script>
