<template>
  <MinipLayout title="营销中心" :canBack="true" tabbar="enterprise">
    ...
    <div class="grid">
      <router-link to="/minip/marketing/activity" class="cell">
        <div class="cell-icon" style="background:#dbeafe">🎯</div>
        <span>活动</span>
      </router-link>
      <router-link to="/minip/marketing/coupon" class="cell">
        <div class="cell-icon" style="background:#dcfce7">🎟️</div>
        <span>优惠券</span>
      </router-link>
      <router-link to="/minip/marketing/member" class="cell">
        <div class="cell-icon" style="background:#fef3c7">👑</div>
        <span>会员</span>
      </router-link>
      <router-link to="/minip/marketing/referral" class="cell">
