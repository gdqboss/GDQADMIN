...
async function load() {
  try {
    ...
    list.value = [
      { id: 1, invoice_no: 'INV-2031', customer: '广州百货', amount: 5600, date: '2026-07-10', status: 'issued' },
      { id: 2, invoice_no: 'INV-2030', customer: '深圳连锁', amount: 12800, date: '2026-07-08', status: 'pending' }
    ]
  }
}
