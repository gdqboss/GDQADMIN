<template>
  <MinipLayout title="财务中心" :canBack="true" tabbar="enterprise">
    ...
    <div class="action-grid">
      <router-link to="/minip/finance/expense" class="action-cell">
        <div class="action-icon">📤</div>
        <span>报销</span>
      </router-link>
      <router-link to="/minip/finance/receipt" class="action-cell">
        <div class="action-icon">📥</div>
        <span>收款</span>
      </router-link>
      <router-link to="/minip/finance/wallet" class="action-cell">
        <div class="action-icon">💳</div>
        <span>钱包</span>
      </router-link>
      <router-link to="/minip/finance/invoice" class="action-cell">
        <div class="action-icon">🧾</div>
        <span>发票</span>
      </router-link>
    </div>
