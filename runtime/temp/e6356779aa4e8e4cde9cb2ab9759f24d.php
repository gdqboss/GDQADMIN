<?php /*a:3:{s:59:"/www/wwwroot/gdqshop.cn/app/view/mendian/choosemendian.html";i:1747926690;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<script>
  ...
  var tableIns = table.render({
    elem: '#tabledata'
    ,url: "<?php echo url('chooseindex'); ?>" //数据接口
    ,page: true //开启分页
    ,cols: [[ //表头
			{type:"checkbox"},
		  ...
		  {field: 'operation', title: '操作',templet: '<div><button class="table-btn" onclick="choosemendian(\'{{d.id}}\')">选择</button></div>',align:'center'}
    ]]
  });
	function choosemendian(id){
		var index = layer.load();
		$.post("<?php echo url('choosemendian'); ?>",{id:id},function(res){
			layer.close(index);
            window.parent.choosemendian(res.data,"<?php echo app('request')->param('args'); ?>");
