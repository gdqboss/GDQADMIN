<?php /*a:2:{s:50:"/www/wwwroot/gdqshop.cn/app/view/index/lianxi.html";i:1747926690;s:55:"/www/wwwroot/gdqshop.cn/app/view/index/public/menu.html";i:1747926690;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
	<meta charset="UTF-8">
	...
	<link rel="stylesheet" href="/static/index/css/lianxi.css?v=<?php echo time(); ?>">
...
<div class="toptab">
	...
	<div class="con">
		<div class="f1">欢迎联系我们~</div>
		<div class="f2">真诚服务，您可以通过以下方式联系到我们</div>
	</div>
</div>
<div class="bannertip">
	...
	<div class="con">
		<div class="">
			<input type="text" value="" placeholder="您的称呼" class="inp1" id="realname"/>
			<input type="text" value="" placeholder="您的联系方式" class="inp1" id="tel"/>
		</div>
		<textarea class="inp2" placeholder="留言内容..." id="content"></textarea>
		<div class="flex">
			<input type="text" value="" placeholder="图形验证码" class="inp1 " id="captcha"/>
			<img src="<?php echo captcha_src(); ?>" class="layadmin-user-login-codeimg" width="180" height="55" id="LAY-user-get-vercode">
		</div>
		<div class="btn1" onclick="submsg()">提交留言</div>
	</div>
</div>
...
<div class="contentbox">
	<div class="content">
		<div class="left">
			<div class="f1"><img src="<?php echo $webinfo['logo']; ?>"/>&nbsp;<?php echo $webinfo['webname']; ?></div>
			<div class="f2"><?php echo $webinfo['company']; ?></div>
		</div>
		<div class="right">
			<div class="item">
				<img src="/static/index/img/lianxi-address.png"/>
				<div class="f2">地址：<?php echo $webinfo['address']; ?></div>
			</div>
			<div class="item">
				<img src="/static/index/img/lianxi-email.png"/>
				<div class="f2">邮箱：<?php echo $webinfo['email']; ?></div>
			</div>
			<div class="item">
				<img src="/static/index/img/lianxi-tel.png"/>
				<div class="f2">电话：<?php echo $webinfo['tel']; ?></div>
			</div>
			<div class="item">
				<img src="/static/index/img/lianxi-weixin.png"/>
				<div class="f2">微信：<?php echo $webinfo['weixin']; ?></div>
			</div>
		</div>
	</div>
</div>
...
function submsg(){
	...
	if(!realname){
		alert('请填写您的称呼');return;
	}
	if(!tel){
		alert('请填写您的联系方式');return;
	}
	if(!content){
		alert('请填写留言内容');return;
	}
	if(!captcha){
		alert('请填写验证码');return;
	}
	doing = true;
	$.post('',{realname:realname,tel:tel,content:content,captcha:captcha},function(res){
		alert(res.msg);
		if(res.status == 1)
