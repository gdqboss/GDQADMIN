<?php /*a:4:{s:60:"/www/wwwroot/gdqshop.cn/app/view/collage_category/index.html";i:1747926690;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;s:54:"/www/wwwroot/gdqshop.cn/app/view/public/copyright.html";i:1747926690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<script>
  ...
  var tableIns = table.render({
    ...
    ,cols: [[ //表头
      ...
      {field: 'operation', title: '操作',templet: '<div><button class="table-btn" onclick="openmax(\'<?php echo url('edit'); ?>/id/{{d.id}}\')">编辑</button><button class="table-btn" onclick="datadel({{d.id}})">删除</button>{{# if(d.pid==0){ }}<!-- <button class="table-btn" onclick="openmax(\'<?php echo url('edit'); ?>/pid/{{d.id}}\')">添加子分类</button>-->{{# } }}</div>',width:150}
    ]]
  });
	//排序
