<?php /*a:3:{s:70:"/www/wwwroot/gdqshop.cn/app/view/product_supplier/choose_supplier.html";i:1747926690;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;}*/ ?>
...
<script>
	...
	var tableIns = table.render({
		...
		,cols: [[ //表头
			...
			{field: 'operation', title: '操作',templet: '<div><button class="table-btn" onclick="chooseSupplier(\'{{d.id}}\')">选择</button></div>',align:'center'}
		]]
	});
	function chooseSupplier(id){
		var index = layer.load();
		$.post("<?php echo url('chooseSupplier'); ?>",{id:id},function(res){
			layer.close(index);
			window.parent.chooseSupplier(res.data,"<?php echo app('request')->param('args'); ?>");
