<?php /*a:3:{s:67:"/www/wwwroot/gdqshop.cn/app/view/collage_product/chooseproduct.html";i:1747926690;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<script>
  ...
  var tableIns = table.render({
    elem: '#tabledata'
    ,url: "<?php echo url('index'); if(input('param.showallbusiness')): ?>&showallbusiness=<?php echo app('request')->param('showallbusiness'); ?><?php endif; ?>" //数据接口
    ,page: true //开启分页
    ,cols: [[ //表头
			//{type:"checkbox"},
      {field: 'id', title: 'ID',  sort: true,width:80},
      {field: 'name', title: '商品信息',templet: '#nameTpl',width:320},
	...
	function choosepro(id){
		var index = layer.load();
		$.post("<?php echo url('getproduct'); ?>",{proid:id},function(res){
			layer.close(index);
			if('<?php echo app('request')->param('type'); ?>'=='2'){
				window.parent.choosepro2(res,"<?php echo app('request')->param('args'); ?>");
			}else{
				window.parent.choosecollage(res.product,"<?php echo app('request')->param('args'); ?>");
			}
