<?php /*a:4:{s:51:"/www/wwwroot/gdqshop.cn/app/view/freight/index.html";i:1747926690;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;s:54:"/www/wwwroot/gdqshop.cn/app/view/public/copyright.html";i:1747926690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="layui-fluid">
    <div class="layui-row layui-col-space15">
        <div class="layui-card layui-col-md12">
          <div class="layui-card-header">配送方式设置</div>
...
<script>
  ...
  var tableIns = table.render({
    ...
    ,cols: [[ //表头
	  ...
	  {field: 'name', title: '配送方式',templet: function(d){
		  if(d.pstype == '0'){
			  return '普通快递';
		  }else if(d.pstype == '1'){
			  return '到店自提';
      ...
      {field: 'free_price', title: '满额包邮',width:150,templet:function(d){
				if(d.freeset == '0' || d.pstype==1) return '不开启';
      ...
      {field: 'status', title: '状态',templet:function(d){ return d.status==1?'<span style="color:green">开启</span>':'<span style="color:red">关闭</span>'},width:80},
      {field: 'operation', title: '操作',templet: function(d){
				...
				if(d.pstype == 3 && d.pscontenttype == 1){
					html += '<br><button class="table-btn" onclick="openmax(\'<?php echo url('codelist'); ?>/fid/'+d.id+'/isopen/1\')">卡密信息</button>';
				}
				return html;
      },width:150}
    ]]
