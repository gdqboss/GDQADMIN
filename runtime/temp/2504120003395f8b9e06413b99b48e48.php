<?php /*a:4:{s:49:"/www/wwwroot/gdqshop.cn/app/view/yuyue/index.html";i:1747926690;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;s:54:"/www/wwwroot/gdqshop.cn/app/view/public/copyright.html";i:1747926690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="layui-fluid">
    <div class="layui-row layui-col-space15">
        <div class="layui-card layui-col-md12">
          <div class="layui-card-header">服务类型</div>
          <div class="layui-card-body" pad15>
						<div class="layui-col-md4" style="padding-bottom:10px">
							
							<?php if(!getcustom('hmy_yuyue') || $set['isapi']!=1): ?>
  ...
  var tableIns = table.render({
    ...
    ,cols: [[ //表头
      ...
      {field: 'operation', title: '操作',templet: function(d){
				...
				if(d.pid==0){
					html += '<button class="table-btn" onclick="openmax(\'<?php echo url('edit'); ?>/pid/'+d.id+'\')">添加子分类</button>';
				}
				return html;
      },width:250}
    ]]
	...
	function showurl(id,type){
		<?php if($bid > 0): ?>
		var pagepath = 'yuyue/yuyue/prolist?bid=<?php echo $bid; ?>&cid='+id;
		<?php else: ?>
	  var pagepath = 'yuyue/yuyue/prolist?cid='+id;
		<?php endif; ?>
		viewLink(pagepath);
	}
	function tongbu(){
		layer.confirm('如果分类较多,同步时间会比较长,请耐心等待,确定要同步吗?',{icon: 7, title:'从师傅APP同步分类数据'}, function(index){
			layer.close(index)
			infonum = 0;
			next_openid = '';
			totalpage = 0;
			...
			$.post("<?php echo url('tongbu'); ?>",{ op:'getpage'},function(data){
				if(data.status==0){
