<?php /*a:3:{s:68:"/www/wwwroot/gdqshop.cn/app/view/barcode_inventory/create_check.html";i:1768704632;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-card layui-col-md12">
                <div class="layui-card-header">
                    ...
                    <a href="<?php echo url('BarcodeInventory/check'); ?>" class="layui-btn layui-btn-sm layui-btn-primary" style="margin-left:10px;">
                        <i class="fa fa-arrow-left"></i> <?php echo t('返回列表'); ?>
                    </a>
                </div>
                <div class="layui-card-body" pad15>
                    <form class="layui-form form-label-w6" id="createCheckForm" lay-filter="createCheckForm">
                        <div class="layui-form-item">
                            <label class="layui-form-label"><span class="redstar">*</span><?php echo t('盘点名称'); ?>：</label>
                            <div class="layui-input-inline" style="width:400px">
                                <input type="text" class="layui-input" name="check_name" placeholder="<?php echo t('请输入盘点名称'); ?>" required>
                            </div>
                            <div class="layui-form-mid layui-word-aux"><?php echo t('例如：2024年1月盘点'); ?></div>
                        </div>
                        
                        <div class="layui-form-item">
                            <label class="layui-form-label"><?php echo t('备注'); ?>：</label>
                            <div class="layui-input-inline" style="width:400px">
                                <textarea class="layui-textarea" name="remark" placeholder="<?php echo t('请输入备注信息'); ?>" rows="3"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                <button class="layui-btn" type="submit" lay-submit lay-filter="createCheckForm">
                                    <i class="fa fa-check"></i> <?php echo t('创建盘点任务'); ?>
                                </button>
...
<script>
    ...
    <script>
        layui.use(['form', 'layer'], function() {
            ...
            // 表单提交
            form.on('submit(createCheckForm)', function(data) {
                $.ajax({
                    url: '<?php echo url('BarcodeInventory/create_check'); ?>',
                    type: 'POST',
                    data: $('#createCheckForm').serialize(),
                    dataType: 'json',
