<?php /*a:4:{s:53:"/www/wwwroot/gdqshop.cn/app/view/shop_fuwu/index.html";i:1747926690;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;s:54:"/www/wwwroot/gdqshop.cn/app/view/public/copyright.html";i:1747926690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="layui-fluid">
    <div class="layui-row layui-col-space15">
        <div class="layui-card layui-col-md12">
          <div class="layui-card-header">商品服务</div>
          <div class="layui-card-body" pad15>
						<blockquote class="layui-elem-quote">用于在商品详情页显示服务标签,如七天退换、正品保障等</blockquote>
...
<script>
  ...
  var tableIns = table.render({
    ...
    ,cols: [[ //表头
      ...
      {field: 'operation', title: '操作',templet: '<div><button class="table-btn" onclick="openmax(\'<?php echo url('edit'); ?>/id/{{d.id}}\')">编辑</button><button class="table-btn" onclick="datadel({{d.id}})">删除</button></div>',width:150}
    ]]
  });
	//排序
