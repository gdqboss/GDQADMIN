<?php /*a:4:{s:59:"/www/wwwroot/gdqshop.cn/app/view/product_supplier/edit.html";i:1766192284;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;s:54:"/www/wwwroot/gdqshop.cn/app/view/public/copyright.html";i:1747926690;}*/ ?>
    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-card layui-col-md12">
				<div class="layui-card-header">
					<?php if(!$info['id']): ?><i class="fa fa-plus"></i> 添加供应商<?php else: ?><i class="fa fa-pencil"></i> 编辑供应商<?php endif; ?>
					<i class="layui-icon layui-icon-close" style="font-size:18px;font-weight:bold;cursor:pointer" onclick="closeself()"></i>
				</div>
				<div class="layui-card-body" pad15>
					<form class="layui-form form-label-w8" method="post" action="<?php echo url('save'); ?>">
						<input type="hidden" name="id" value="<?php echo $info['id']; ?>"/>
						<div class="layui-form-item">
							<label class="layui-form-label"><span class="redstar">*</span>供应商名称：</label>
							<div class="layui-input-inline" style="width:400px">
								<input type="text" name="info[supplier_name]" lay-verify="required" lay-verType="tips" class="layui-input" value="<?php echo $info['supplier_name']; ?>">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">供应商编号：</label>
							<div class="layui-input-inline" style="width:400px">
								<input type="text" name="info[supplier_number]" class="layui-input" value="<?php echo $info['supplier_number']; ?>">
							</div>
						</div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline" style="width:200px">
                                <input type="text" name="info[tel]" lay-verify="required|tel" lay-verType="tips" class="layui-input" value="<?php echo $info['tel']; ?>">
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline" style="width:200px">
                                <input type="text" name="info[account]" lay-verify="required" lay-verType="tips" class="layui-input" value="<?php echo $info['account']; ?>">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <?php if($info['password']): ?><div class="layui-form-mid layui-word-aux">密码已设置</div><?php endif; ?>
                        </div>
