<?php /*a:5:{s:53:"/www/wwwroot/gdqshop.cn/app/view/user_group/edit.html";i:1747926690;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:54:"/www/wwwroot/gdqshop.cn/app/view/public/user_auth.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;s:54:"/www/wwwroot/gdqshop.cn/app/view/public/copyright.html";i:1747926690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-card layui-col-md12">
			 <div class="layui-card-header">
				<?php if(!$info['id']): ?><i class="fa fa-plus"></i> 新增权限组<?php else: ?><i class="fa fa-pencil"></i> 编辑权限组<?php endif; ?>
				...
				<div class="layui-card-body" pad15>
					<div class="layui-form form-label-w6" lay-filter="">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="info[sort]" class="layui-input" value="<?php echo $info['sort']; ?>">
							</div>
							<div class="layui-word-aux layui-clear">权重越高代表权限越大，低权重的权限组的用户无法添加高权重的权限组的用户</div>
						</div>
						<?php endif; ?>
						<div class="layui-form-item">
						...
						<?php if(!$type): if($thisuser_mdid == 0): ?>
							<div class="layui-form-item">
								...
								<div class="layui-word-aux layui-clear">指定门店后，该权限组的管理员的订单权限只能看到指定门店的订单</div>
							</div>
							<?php elseif(!$info['id']): ?>
