<?php /*a:4:{s:56:"/www/wwwroot/gdqshop.cn/app/view/shop_category/edit.html";i:1747926690;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;s:54:"/www/wwwroot/gdqshop.cn/app/view/public/copyright.html";i:1747926690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
							...
							<div class="layui-input-inline">
								<select name="info[pid]">
									...
									<?php foreach($pcatelist as $pcate): ?>
										...
										<?php foreach($pcate['child'] as $v): ?>
										<option value="<?php echo $v['id']; ?>" <?php if($v['id']==$info['pid']): ?>selected<?php endif; ?>>&nbsp;&nbsp;&nbsp;<?php echo $v['name']; ?></option>
										<?php endforeach; ?>
									<?php endforeach; ?>
								</select>
							</div>
							...
							<div id="picPreview" class="picsList-class-padding">
								<div class="layui-imgbox imgbox-required">
									...
									<div class="layui-imgbox">
										...
										<input autocomplete='off' type="text" id="pic" name="info[pic]"  value="<?php echo $info['pic']; ?>" style="cursor:default;">
									</div>
								</div>
							</div>
						</div>
