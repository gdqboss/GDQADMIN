<?php /*a:4:{s:57:"/www/wwwroot/gdqshop.cn/app/view/mendian_group/index.html";i:1747926690;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;s:54:"/www/wwwroot/gdqshop.cn/app/view/public/copyright.html";i:1747926690;}*/ ?>
<!DOCTYPE html>   <!--custom_file(mendian_upgrade)-->
<html>
<head>
  <meta charset="utf-8">
  <title><?php echo t('门店'); ?>分组</title>
  ...
  <div class="layui-fluid">
    <div class="layui-row layui-col-space15">
        <div class="layui-card layui-col-md12">
          <div class="layui-card-header"><?php echo t('门店'); ?>分组</div>
...
<script>
  ...
  var tableIns = table.render({
    ...
    ,cols: [[ //表头
      ...
      {field: 'operation', title: '操作',templet: '<div><button class="table-btn" onclick="openmax(\'<?php echo url('edit'); ?>/id/{{d.id}}\')">编辑</button><button class="table-btn" onclick="datadel({{d.id}})">删除</button></div>',width:250}
    ]]
  });
	//排序
