<?php /*a:3:{s:64:"/www/wwwroot/gdqshop.cn/app/view/barcode_inventory/settings.html";i:1768722663;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="layui-row layui-col-space15">
                        <div class="layui-col-md6">
                            <div class="layui-card">
                                <div class="layui-card-header">
                                    <i class="fa fa-building"></i> <?php echo t('经销商管理'); ?>
                                </div>
                                <div class="layui-card-body">
                                    <p><?php echo t('管理系统中的经销商信息，包括添加、编辑、删除经销商，以及管理经销商下的门店。'); ?></p>
                                    <br>
                                    <button class="layui-btn layui-btn-primary" onclick="window.location.href='/?s=/BarcodeInventory/dealer_list'">
                                        <i class="fa fa-arrow-right"></i> <?php echo t('进入经销商管理'); ?>
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div class="layui-col-md6">
                            <div class="layui-card">
                                <div class="layui-card-header">
                                    <i class="fa fa-cog"></i> <?php echo t('其他设置'); ?>
                                </div>
                                <div class="layui-card-body">
                                    <p><?php echo t('系统其他设置功能将在此处添加。'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
