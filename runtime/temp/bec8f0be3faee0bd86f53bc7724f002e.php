<?php /*a:3:{s:67:"/www/wwwroot/gdqshop.cn/app/view/product_qrcode/batch_generate.html";i:1768361017;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <script>
    layui.use(['form', 'layer', 'jquery'], function() {
      ...
      form.on('submit(batchGenerate)', function(data) {
        ...
        // 发送AJAX请求批量生成二维码
        $.ajax({
          url: '<?php echo url("ApiQrcode/batchGenerate"); ?>',
          type: 'POST',
          data: data.field,
          dataType: 'JSON',
          success: function(res) {
            ...
            if (res.status == 1) {
              ...
              $.each(res.qrcodes, function(index, qrcode) {
                ...
                html += '<a href="<?php echo url("ProductQrcode/detail"); ?>?id=' + qrcode.id + '" class="layui-btn layui-btn-xs layui-btn-normal">详情</a>';
                html += '</div>';
                html += '</div>';
              });
      ...
      $('#viewAllBtn').click(function() {
        window.location.href = '<?php echo url("ProductQrcode/index"); ?>';
      });
    });
  </script>
</body>
