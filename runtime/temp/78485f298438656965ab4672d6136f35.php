...
<div class="layui-fluid">
	<div class="layui-row layui-col-space15">
		<div class="layui-card layui-col-md12">
			<div class="layui-card-header"><i class="fa fa-edit"></i> <?php echo t('会员'); ?>编辑<i class="layui-icon layui-icon-close" style="font-size:18px;font-weight:bold;cursor:pointer" onclick="closeself()"></i></div>
					...
					<div class="layui-form form-label-w6" lay-filter="form">
						...
						<div class="layui-tab layui-tab-brief" lay-filter="mytab">
							<ul class="layui-tab-title">
								...
								<?php if(getcustom('register_fields')): ?><li lay-id="2">扩展信息</li><?php endif; if(getcustom('member_set')): ?><li lay-id="2">资料设置</li><?php endif; if(getcustom('member_richinfo')): ?><li lay-id="2">详细介绍</li><?php endif; ?>
							</ul>
							<div class="layui-tab-content">
								<!--基本信息start-->
								<div class="layui-tab-item layui-show">
									<?php if($info['mpopenid']): ?>
									<div class="layui-form-item">
										<label class="layui-form-label">公众号openid</label>
										<div class="layui-form-mid"><?php echo $info['mpopenid']; ?></div>
									</div>
									<?php endif; if($info['wxopenid']): ?>
									<div class="layui-form-item">
										<label class="layui-form-label">微信小程序openid</label>
										<div class="layui-form-mid"><?php echo $info['wxopenid']; ?></div>
									</div>
									<?php endif; if(getcustom('xixie')): ?>
									<div class="layui-form-item">
										<label class="layui-form-label">门店</label>
										<div class="layui-input-inline">
											<select name="info[mdid]" lay-filter="yxqset" class="levelid">
												<option value="" >无</option>
												<?php foreach($mendian as $v): ?>
												<option value="<?php echo $v['id']; ?>" <?php if($v['id'] == $info['mdid']): ?>selected<?php endif; ?>><?php echo $v['name']; ?></option>
												<?php endforeach; ?>
											</select>
										</div>
									</div>
									...
									<div class="layui-form-item">
										...
										<div class="layui-input-inline">
											<input type="text" name="info[nickname]" lay-verify="required" lay-verType="tips" class="layui-input" value="<?php echo $info['nickname']; ?>">
										</div>
									</div>
									<div class="layui-form-item">
										<label class="layui-form-label">姓名</label>
										<div class="layui-input-inline">
											<input type="text" name="info[realname]" class="layui-input" value="<?php echo $info['realname']; ?>">
										</div>
									</div>
									<div class="layui-form-item">
									...
									<div class="layui-form-item">
										...
										<div class="layui-input-inline">
											<input type="text" name="info[usercard]" class="layui-input" value="<?php echo $info['usercard']; ?>">
										</div>
									</div>
									<div class="layui-form-item">
										<label class="layui-form-label">性别</label>
										<div class="layui-input-inline" style="width:700px">
											<input type="radio" name="info[sex]" value="1" lay-filter="areafenhongChange" <?php if($info['sex']==1): ?>checked<?php endif; ?> title="男"/>
											<input type="radio" name="info[sex]" value="2" lay-filter="areafenhongChange" <?php if($info['sex']==2): ?>checked<?php endif; ?> title="女"/>
											<input type="radio" name="info[sex]" value="0"  <?php if($info['sex']==0): ?>checked<?php endif; ?> title="未知"/>
										</div>
									</div>
									<div class="layui-form-item">
										<label class="layui-form-label">生日</label>
										<div class="layui-input-inline">
											<input type="text" id="birthday" name="info[birthday]" class="layui-input" value="<?php echo $info['birthday']; ?>">
										</div>
									</div>
									<?php if(getcustom('pos_score_tongji')): ?>
									<div class="layui-form-item ">
										<label class="layui-form-label">pos积分奖励比例</label>
										<div class="layui-input-inline">
											<input type="text" name="info[pos_score_ratio]" class="layui-input" value="<?php echo $info['pos_score_ratio']; ?>">
										</div>
									...
									<div class="level-box">
										<div class="layui-form-item">
											...
											<div class="layui-input-inline">
												<select name="info[levelid]" lay-verify="required" lay-filter="yxqset" class="levelid">
													...
													<option value="<?php echo $v['id']; ?>" <?php if($v['id'] == $info['levelid']): ?>selected<?php endif; ?>><?php echo $v['name']; ?></option>
													<?php endforeach; ?>
												</select>
											</div>
											<div id="yxqset" <?php if($defaultlevel['id'] == $info['levelid']): ?>style="display:none"<?php endif; ?>>
												<div class="layui-form-mid">有效期</div>
												<div class="layui-input-inline" id="levelendtime_div" style="<?php if($info['levelendtime']==0): ?>display:none<?php endif; ?>">
													<input type="text" name="info[levelendtime]" id="levelendtime" autocomplete="off" class="layui-input" value="<?php echo $info['levelendtime']>0 ? date('Y-m-d',$info['levelendtime'])  :  ''; ?>">
												</div>
												<div class="layui-input-inline">
													<input type="checkbox" name="levelcq" value="1" <?php if($info['levelendtime']==0): ?>checked<?php endif; ?> title="长期" lay-filter="levelcq"/>
												</div>
											</div>
										</div>
										<div class="layui-form-item">
											...
											<div class="layui-input-inline" style="width:700px">
												<input type="radio" name="info[areafenhong]" value="0" lay-filter="areafenhongChange" <?php if($info['areafenhong']==0): ?>checked<?php endif; ?> title="跟随会员等级设置"/>
												<?php if(getcustom('areafenhong_jiaquan') && ($auth_data=='all' || in_array('Largearea/*',$auth_data))): ?>
												<input type="radio" name="info[areafenhong]" value="10" lay-filter="areafenhongChange" <?php if($info['areafenhong']==10): ?>checked<?php endif; ?> title="大区代理"/>
												<?php endif; ?>
												<input type="radio" name="info[areafenhong]" value="1" lay-filter="areafenhongChange" <?php if($info['areafenhong']==1): ?>checked<?php endif; ?> title="省级代理"/>
												<input type="radio" name="info[areafenhong]" value="2" lay-filter="areafenhongChange" <?php if($info['areafenhong']==2): ?>checked<?php endif; ?> title="市级代理"/>
												<input type="radio" name="info[areafenhong]" value="3" lay-filter="areafenhongChange" <?php if($info['areafenhong']==3): ?>checked<?php endif; ?> title="区县代理"/>
												<input type="radio" name="info[areafenhong]" value="4" lay-filter="areafenhongChange" <?php if($info['areafenhong']==4): ?>checked<?php endif; ?> title="非区域代理"/>
											</div>
										</div>
										<div class="layui-form-item areafenhong_address" <?php if(($info['areafenhong']==0 && $levelArr[$info['levelid']]['areafenhong']==0) || $info['areafenhong']==4): ?>style="display:none"<?php endif; ?>>
											<label class="layui-form-label">代理区域</label>
											<?php if(getcustom('areafenhong_jiaquan') && ($auth_data=='all' || in_array('Largearea/*',$auth_data))): ?>
											<div class="layui-input-inline areafenhong_largearea_div" <?php if(($info['areafenhong']==0 && $levelArr[$info['levelid']]['areafenhong']!=10) || in_array($info['areafenhong'],[1,2,3])): ?>style="display:none"<?php endif; ?>>
												<select name="info[areafenhong_largearea]" id="areafenhong_largearea">
													<option value="">请选择大区</option>
													<?php  $largearealist = db('largearea')->where('aid',$aid)->where('status',1)->order('sort desc,id')->column('name'); foreach($largearealist as $largearea): ?>
													<option value="<?php echo $largearea; ?>" <?php if($info['areafenhong_largearea'] == $largearea): ?>selected<?php endif; ?>><?php echo $largearea; ?></option>
													<?php endforeach; ?>
												</select>
											</div>
											<?php endif; ?>
											<div class="layui-input-inline areafenhong_province_div" <?php if(($info['areafenhong']==0 && !in_array($levelArr[$info['levelid']]['areafenhong'],[1,2,3])) || $info['areafenhong']==10): ?>style="display:none"<?php endif; ?>>
												<select name="info[areafenhong_province]" id="areafenhong_province" lay-filter="areafenhong_province"></select>
											</div>
											<div class="layui-input-inline areafenhong_city_div" <?php if(($info['areafenhong']==0 && !in_array($levelArr[$info['levelid']]['areafenhong'],[2,3])) || in_array($info['areafenhong'],[1,10])): ?>style="display:none"<?php endif; ?>>
												<select name="info[areafenhong_city]" id="areafenhong_city" lay-filter="areafenhong_city"></select>
											</div>
											<div class="layui-input-inline areafenhong_area_div" <?php if(($info['areafenhong']==0 && $levelArr[$info['levelid']]['areafenhong']!=3) || in_array($info['areafenhong'],[1,2,10])): ?>style="display:none"<?php endif; ?>>
												<select name="info[areafenhong_area]" id="areafenhong_area"></select>
											</div>
										</div>
										<?php if(getcustom('member_area_agent_multi')): ?>
										<div class="layui-form-item">
										...
										<?php endif; if(getcustom('member_area_agent_multi_price')): ?>
										<div class="layui-form-item">
											<label class="layui-form-label">区域分红金额</label>
											<div class="layui-input-inline layui-module-itemL">
												<div>省(元) </div>
												<input type="text" name="info[areafenhong_province_commission]" class="layui-input" value="<?php echo $info['areafenhong_province_commission']; ?>">
											</div>
											<div class="layui-input-inline layui-module-itemL">
												<div>市(元)</div>
												<input type="text" name="info[areafenhong_city_commission]" class="layui-input" value="<?php echo $info['areafenhong_city_commission']; ?>">
											</div>
											<div class="layui-input-inline layui-module-itemL">
												<div>区县(元)</div>
												<input type="text" name="info[areafenhong_area_commission]" class="layui-input" value="<?php echo $info['areafenhong_area_commission']; ?>">
											</div>
										...
										<?php endif; ?>
										<div class="layui-form-item areafenhong_bili" <?php if(!in_array($info['areafenhong'],[1,2,3])): ?>style="display:none"<?php endif; ?>>
											<label class="layui-form-label">分红比例</label>
											<div class="layui-input-inline">
												<input type="text" name="info[areafenhongbl]" class="layui-input" value="<?php echo $info['areafenhongbl']; ?>">
											</div>
											<div class="layui-form-mid">%</div>
										...
										<div class="layui-form-item areafenhong_bili" <?php if(!in_array($info['areafenhong'],[1,2,3])): ?>style="display:none"<?php endif; ?>>
											...
											<div class="layui-input-inline">
												<input type="text" name="info[areafenhongbl_maidan]" class="layui-input" value="<?php echo $info['areafenhongbl_maidan']; ?>">
											</div>
											<div class="layui-form-mid">%</div>
											<div class="layui-form-mid layui-word-aux">区域代理的分红比例</div>
										</div>
									...
									<?php if($levelExtendList): foreach($levelExtendList as $levelExtend): ?>
									<div class="level-box">
										<div class="layui-form-item">
											...
											<div class="layui-input-inline">
												<select name="record[levelid]" class="levelid" lay-verify="required">
													...
													<?php foreach($level_category_extend as $v): ?>
													<optgroup label="<?php echo $v['name']; ?>">
														<?php foreach($v['level_list'] as $level): ?>
														<option value="<?php echo $level['id']; ?>" <?php if($level['id'] == $levelExtend['levelid']): ?>selected<?php endif; ?>><?php echo $level['name']; ?></option>
														<?php endforeach; ?>
													</optgroup>
													<?php endforeach; ?>
												</select>
											...
											<div>
												<div class="layui-form-mid">有效期</div>
												<div class="layui-input-inline" id="level_extend_endtime_div" style="<?php if($info['level_extend_endtime']==0): ?>display:none<?php endif; ?>">
													<input type="text" name="record[levelendtime]" id="level_extend_endtime" autocomplete="off" class="layui-input" value="<?php echo $levelExtend['levelendtime']>0 ? date('Y-m-d',$levelExtend['levelendtime'])  :  ''; ?>">
												</div>
												<div class="layui-input-inline">
													<input type="checkbox" name="level_extend_cq" value="1" <?php if($levelExtend['levelendtime']==0): ?>checked<?php endif; ?> title="长期" lay-filter="level_extend_cq"/>
												</div>
											</div>
										</div>
										<div class="layui-form-item">
											<label class="layui-form-label">区域代理</label>
											<div class="layui-input-inline" style="width:700px">
												<input type="radio" name="record[areafenhong]" value="0" lay-filter="areafenhongChange" <?php if($levelExtend['areafenhong']==0): ?>checked<?php endif; ?> title="跟随会员等级设置"/>
												<input type="radio" name="record[areafenhong]" value="1" lay-filter="areafenhongChange" <?php if($levelExtend['areafenhong']==1): ?>checked<?php endif; ?> title="省级代理"/>
												<input type="radio" name="record[areafenhong]" value="2" lay-filter="areafenhongChange" <?php if($levelExtend['areafenhong']==2): ?>checked<?php endif; ?> title="市级代理"/>
												<input type="radio" name="record[areafenhong]" value="3" lay-filter="areafenhongChange" <?php if($levelExtend['areafenhong']==3): ?>checked<?php endif; ?> title="区县代理"/>
												<input type="radio" name="record[areafenhong]" value="4" lay-filter="areafenhongChange" <?php if($levelExtend['areafenhong']==4): ?>checked<?php endif; ?> title="非区域代理"/>
											</div>
										</div>
										<div class="layui-form-item areafenhong_address" <?php if(($levelExtend['areafenhong']==0 && $levelArr[$levelExtend['levelid']]['areafenhong']==0) || $levelExtend['areafenhong']==4): ?>style="display:none"<?php endif; ?>>
											<label class="layui-form-label">代理区域</label>
											<div class="layui-input-inline">
												<select name="record[areafenhong_province]" id="areafenhong_province_<?php echo $levelExtend['id']; ?>" lay-filter="areafenhong_province_<?php echo $levelExtend['id']; ?>"></select>
											</div>
											<div class="layui-input-inline areafenhong_city_div" <?php if(($levelExtend['areafenhong']==0 && !in_array($levelArr[$levelExtend['levelid']]['areafenhong'],[2,3])) || $levelExtend['areafenhong']==1): ?>style="display:none"<?php endif; ?>>
												<select name="record[areafenhong_city]" id="areafenhong_city_<?php echo $levelExtend['id']; ?>" lay-filter="areafenhong_city_<?php echo $levelExtend['id']; ?>"></select>
											</div>
											<div class="layui-input-inline areafenhong_area_div" <?php if(($levelExtend['areafenhong']==0 && $levelArr[$levelExtend['levelid']]['areafenhong']!=3) || in_array($levelExtend['areafenhong'],[1,2])): ?>style="display:none"<?php endif; ?>>
												<select name="record[areafenhong_area]" id="areafenhong_area_<?php echo $levelExtend['id']; ?>"></select>
											</div>
										</div>
										<div class="layui-form-item areafenhong_bili" <?php if(!in_array($levelExtend['areafenhong'],[1,2,3])): ?>style="display:none"<?php endif; ?>>
											<label class="layui-form-label">分红比例</label>
											<div class="layui-input-inline">
												<input type="text" name="record[areafenhongbl]" class="layui-input" value="<?php echo $levelExtend['areafenhongbl']; ?>">
											</div>
											<div class="layui-form-mid">%</div>
											<div class="layui-form-mid layui-word-aux">区域代理的分红比例</div>
										</div>
									</div>
									<input type="hidden" name="record[id]" value="<?php echo $levelExtend['id']; ?>" >
										...
										<div class="layui-form-item">
											...
											<div class="layui-input-inline">
												<select name="record[levelid]" lay-verify="required">
													...
													<optgroup label="<?php echo $v['name']; ?>">
														<?php foreach($v['level_list'] as $level): ?>
														<option value="<?php echo $level['id']; ?>" <?php if($level['id'] == $levelExtend['id']): ?>selected<?php endif; ?>><?php echo $level['name']; ?></option>
														<?php endforeach; ?>
													</optgroup>
													<?php endforeach; ?>
												</select>
											...
											<div>
												...
												<div class="layui-input-inline">
													<input type="checkbox" name="record[level_extend_cq]" value="1" <?php if($levelExtend['levelendtime']==0): ?>checked<?php endif; ?> title="长期" lay-filter="level_extend_cq"/>
												</div>
											</div>
										</div>
										<div class="layui-form-item">
											<label class="layui-form-label">区域代理</label>
											<div class="layui-input-inline" style="width:700px">
												<input type="radio" name="record[areafenhong]" value="0" lay-filter="areafenhongChange" <?php if($record['areafenhong']==0): ?>checked<?php endif; ?> title="跟随会员等级设置"/>
												<input type="radio" name="record[areafenhong]" value="1" lay-filter="areafenhongChange" <?php if($record['areafenhong']==1): ?>checked<?php endif; ?> title="省级代理"/>
												<input type="radio" name="record[areafenhong]" value="2" lay-filter="areafenhongChange" <?php if($record['areafenhong']==2): ?>checked<?php endif; ?> title="市级代理"/>
												<input type="radio" name="record[areafenhong]" value="3" lay-filter="areafenhongChange" <?php if($record['areafenhong']==3): ?>checked<?php endif; ?> title="区县代理"/>
												<input type="radio" name="record[areafenhong]" value="4" lay-filter="areafenhongChange" <?php if($record['areafenhong']==4): ?>checked<?php endif; ?> title="非区域代理"/>
											</div>
										</div>
									...
									<div class="layui-form-item">
										...
										<div class="layui-input-inline">
											<input type="text" name="info[pid]" class="layui-input" value="<?php echo $info['pid']; ?>">
										</div>
										<div class="layui-form-mid layui-word-aux">无推荐人请填写0</div>
									</div>
									<?php if(getcustom('member_import_pid_origin')): ?>
									<div class="layui-form-item">
										<label class="layui-form-label">原推荐人ID</label>
										<div class="layui-input-inline">
											<input type="text" name="info[pid_origin]" class="layui-input" value="<?php echo $info['pid_origin']; ?>">
										</div>
									...
									<?php endif; if(getcustom('member_tag') && !$member_tag_pic): ?>
									<div class="layui-form-item">
										<label class="layui-form-label">标签设置</label>
										<div class="layui-input-inline" style="width:500px">
											<?php foreach($tagsdata as $v): ?>
											<input type="checkbox" name="info[tags][]" value="<?php echo $v['id']; ?>" title="<?php echo $v['name']; ?>" <?php if(in_array($v['id'],$info['tags'])): ?>checked<?php endif; ?>/>
											<?php endforeach; ?>
										</div>
									</div>
									<?php endif; if($member_tag_pic): ?>
										<div class="layui-form-item">
											<label class="layui-form-label">标签设置</label>
											<div class="layui-input-inline" style="">
												<select name="info[tags]" lay-filter="yxqset" class="tags">
													<option value="" >无</option>
												<?php foreach($tagsdata as $v): ?>
													<option value="<?php echo $v['id']; ?>" <?php if(in_array($v['id'],$info['tags'])): ?>selected<?php endif; ?>><?php echo $v['name']; ?></option>
												<?php endforeach; ?>
												</select>
											</div>
										</div>
									<?php endif; if($info['tel']  || !$info['id']): ?>
									<div class="layui-form-item">
									...
									<div class="layui-form-item">
										...
										<div class="layui-input-inline">
											<select name="info[identity]" class="layui-select">
												<option value="顾客" <?php if($info['identity'] == '顾客'): ?>selected<?php endif; ?>>顾客</option>
												<option value="公司员工" <?php if($info['identity'] == '公司员工'): ?>selected<?php endif; ?>>公司员工</option>
												<option value="供货商" <?php if($info['identity'] == '供货商'): ?>selected<?php endif; ?>>供货商</option>
												<option value="店主" <?php if($info['identity'] == '店主'): ?>selected<?php endif; ?>>店主</option>
												<option value="店员" <?php if($info['identity'] == '店员'): ?>selected<?php endif; ?>>店员</option>
												<option value="仓管" <?php if($info['identity'] == '仓管'): ?>selected<?php endif; ?>>仓管</option>
											</select>
										</div>
									</div>
									<div class="layui-form-item">
										...
										<div class="layui-input-inline">
											<input type="text" name="info[supplier_id]" class="layui-input" value="<?php echo $info['supplier_id']; ?>">
										</div>
									</div>
									<div class="layui-form-item">
									...
									<div class="layui-form-item">
										...
										<div class="layui-input-inline">
											<input type="text" name="info[fenhong_max]" class="layui-input" value="<?php echo $info['fenhong_max']; ?>">
										</div>
									</div>
									<?php endif; if(getcustom('member_levelup_auth') && $haverechargeAuth): ?>
									<div class="layui-form-item">
										<label class="layui-form-label">赠送/售卖额度</label>
										<div class="layui-input-inline">
											<input type="text" name="info[salelevel_money]" class="layui-input" value="<?php echo $info['salelevel_money']; ?>">
										</div>
									</div>
									...
									<div class="layui-form-item">
										...
										<div class="layui-input-inline">
											<input type="text" name="info[ktnum]" class="layui-input" value="<?php echo $info['ktnum']; ?>">
										</div>
									</div>
									<?php endif; if(getcustom('product_bonus_pool')): ?>
									<div class="layui-form-item">
										<label class="layui-form-label">已获<?php echo t('贡献值'); ?></label>
										<div class="layui-input-inline">
											<input type="text" name="info[bonus_pool_money]" class="layui-input" value="<?php echo $info['bonus_pool_money']; ?>">
										</div>
									</div>
									<div class="layui-form-item">
										<label class="layui-form-label"><?php echo t('贡献值'); ?>上限</label>
										<div class="layui-input-inline">
											<input type="text" name="info[bonus_pool_max_money]" class="layui-input" value="<?php echo $info['bonus_pool_max_money']; ?>">
										</div>
									</div>
									<?php endif; if(getcustom('plug_businessqr')): ?>
									<div class="layui-form-item">
										<label class="layui-form-label">绑定的店铺</label>
										<div class="layui-input-inline">
											<select name="info[bid]" lay-verify="required" lay-filter="yxqset">
												<option value="0">无</option>
												<?php foreach($blist as $v): ?>
												<option value="<?php echo $v['id']; ?>" <?php if($v['id'] == $info['bid']): ?>selected<?php endif; ?>><?php echo $v['name']; ?></option>
												<?php endforeach; ?>
											</select>
										</div>
									</div>
									<?php endif; if(getcustom('business_fenxiao')): ?>
									<div class="layui-form-item">
										<label class="layui-form-label">冻结提现功能</label>
										<div class="layui-input-inline" style="width:700px">
											<input type="radio" name="info[disable_withdraw]" value="0" <?php if($info['disable_withdraw']==0): ?>checked<?php endif; ?> title="否"/>
											<input type="radio" name="info[disable_withdraw]" value="1" <?php if($info['disable_withdraw']==1): ?>checked<?php endif; ?> title="是"/>
										</div>
									</div>
									<?php endif; if(getcustom('member_lock')): ?>
									<div class="layui-form-item">
										<label class="layui-form-label">锁定提现转账</label>
										<div class="layui-input-inline" style="width:700px">
											<input type="radio" name="info[lock_withdraw_givemoney]" value="0" <?php if($info['lock_withdraw_givemoney']==0): ?>checked<?php endif; ?> title="否"/>
											<input type="radio" name="info[lock_withdraw_givemoney]" value="1" <?php if($info['lock_withdraw_givemoney']==1): ?>checked<?php endif; ?> title="是"/>
										</div>						
									</div>
									<?php endif; if(getcustom('member_lock')): ?>
									<div class="layui-form-item">
										...
										<div class="layui-input-inline" style="width:700px">
											<input type="radio" name="info[disabled_login]" value="0" <?php if($info['disabled_login']==0): ?>checked<?php endif; ?> title="否"/>
											<input type="radio" name="info[disabled_login]" value="1" <?php if($info['disabled_login']==1): ?>checked<?php endif; ?> title="是"/>
										</div>										
									</div>
									<?php endif; if(getcustom('wurl_reward')): ?>
									<div class="layui-form-item">
										<label class="layui-form-label">外部链接奖励</label>
										<div class="layui-input-inline" style="width:250px">
											<input type="radio" name="info[wurl_reward_set]" value="0" title="跟随系统设置" <?php if($info['wurl_reward_set']==0 || $info['wurl_reward_set']==''): ?>checked<?php endif; ?> lay-filter="wurl_reward_set">
											<input type="radio" name="info[wurl_reward_set]" value="1" title="单独设置" <?php if($info['wurl_reward_set']==1): ?>checked<?php endif; ?> lay-filter="wurl_reward_set">
										</div>
										<div class="layui-form-mid layui-word-aux">单独设置后扩展-外部链接奖励设置失效，按此处设置分发奖励</div>
									</div>
									<div id="wurlrewardset" <?php if($info['wurl_reward_set'] != 1): ?>style="display:none"<?php endif; ?>>
										<div class="layui-form-item">
											<label class="layui-form-label">点击奖励：</label>
											<div class="layui-input-inline layui-module-itemL">
											  <input type="text" placeholder="<?php echo t('余额'); ?>" name="info[wr_money]" class="layui-input" value="<?php echo !empty($info['wr_money']) ? $info['wr_money'] : '0'; ?>">
											  <span style="margin-left: 3px;margin-right:10px"><?php echo t('余额'); ?></span>
											  <input type="text" placeholder="<?php echo t('积分'); ?>" name="info[wr_score]" class="layui-input" value="<?php echo !empty($info['wr_score']) ? $info['wr_score'] : '0'; ?>">
											  <span style="margin-left: 3px;margin-right:10px"><?php echo t('积分'); ?></span>
											  <input type="text" placeholder="<?php echo t('佣金'); ?>" name="info[wr_commission]" class="layui-input" value="<?php echo !empty($info['wr_commission']) ? $info['wr_commission'] : '0'; ?>">
											  <span style="margin-left: 3px;margin-right:10px"><?php echo t('佣金'); ?></span>
											</div>
										</div>
										<div class="layui-form-item">
											<label class="layui-form-label">每日上限：</label>
											<div class="layui-input-inline layui-module-itemL">
											  <input type="text" placeholder="<?php echo t('余额'); ?>" name="info[wr_money2]" class="layui-input" value="<?php echo !empty($info['wr_money2']) ? $info['wr_money2'] : '0'; ?>">
											  <span style="margin-left: 3px;margin-right:10px"><?php echo t('余额'); ?></span>
											  <input type="text" placeholder="<?php echo t('积分'); ?>" name="info[wr_score2]" class="layui-input" value="<?php echo !empty($info['wr_score2']) ? $info['wr_score2'] : '0'; ?>">
											  <span style="margin-left: 3px;margin-right:10px"><?php echo t('积分'); ?></span>
											  <input type="text" placeholder="<?php echo t('佣金'); ?>" name="info[wr_commission2]" class="layui-input" value="<?php echo !empty($info['wr_commission2']) ? $info['wr_commission2'] : '0'; ?>">
											  <span style="margin-left: 3px;margin-right:10px"><?php echo t('佣金'); ?></span>
											</div>
										</div>
										<div class="layui-form-item">
											...
											<div class="layui-input-inline layui-module-itemL">
											  <input type="text" placeholder="<?php echo t('余额'); ?>" name="info[wr_money3]" class="layui-input" value="<?php echo !empty($info['wr_money3']) ? $info['wr_money3'] : '0'; ?>">
											  <span style="margin-left: 3px;margin-right:10px"><?php echo t('余额'); ?></span>
											  <input type="text" placeholder="<?php echo t('积分'); ?>" name="info[wr_score3]" class="layui-input" value="<?php echo !empty($info['wr_score3']) ? $info['wr_score3'] : '0'; ?>">
											  <span style="margin-left: 3px;margin-right:10px"><?php echo t('积分'); ?></span>
											  <input type="text" placeholder="<?php echo t('佣金'); ?>" name="info[wr_commission3]" class="layui-input" value="<?php echo !empty($info['wr_commission3']) ? $info['wr_commission3'] : '0'; ?>">
											  <span style="margin-left: 3px;margin-right:10px"><?php echo t('佣金'); ?></span>
											</div>
										</div>
									</div>
								  <?php endif; if(getcustom('yx_buy_fenhong')&& ($auth_data=='all' || in_array('BuyFenhong/*',$auth_data))): ?>
									<div class="layui-form-item">
										<label class="layui-form-label"><?php echo t('积分'); ?>权</label>
										<div class="layui-input-inline">
											<input type="text" name="info[buy_fenhong_score_weight]" class="layui-input" value="<?php echo $info['buy_fenhong_score_weight']; ?>">
										</div>
									</div>
									<?php endif; ?>
								</div>
								<!--基本信息End-->
								<!--自定义信息start-->
 								<?php if(getcustom('register_fields')): ?>
  							<input type="hidden" name="formdata[id]" value="<?php echo $register_record['id']; ?>">
  							<div class="layui-tab-item">
									<?php if(is_array($register_record['content']) || $register_record['content'] instanceof \think\Collection || $register_record['content'] instanceof \think\Paginator): $key = 0; $__LIST__ = $register_record['content'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($key % 2 );++$key;
										$formkey = 'form'.($key-1);
										$val = $register_record['form'.($key-1)]??'';
									 if($item['key']=='input'): ?>
									<div class="layui-form-item">
										<label class="layui-form-label"><?php echo $item['val1']; ?></label>
										<div class="layui-input-inline">
											<input type="text" name="formdata[<?php echo $formkey; ?>]" class="layui-input"  value="<?php echo $val; ?>"  >
										</div>
									</div>
									<?php endif; if($item['key']=='textarea'): ?>
									<div class="layui-form-item">
										<label class="layui-form-label"><?php echo $item['val1']; ?></label>
										<div class="layui-input-inline" style="min-width: 300px">
											<textarea class="layui-textarea" name="formdata[<?php echo $formkey; ?>]"><?php echo $val; ?></textarea>
										</div>
									</div>
									<?php endif; if($item['key']=='radio'): ?>
									<div class="layui-form-item">
										<label class="layui-form-label"><?php echo $item['val1']; ?></label>
										<div class="layui-input-inline">
											<?php if(is_array($item['val2']) || $item['val2'] instanceof \think\Collection || $item['val2'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item['val2'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item2): $mod = ($i % 2 );++$i;?>
												<label><input type="radio" name="formdata[<?php echo $formkey; ?>]" title="<?php echo $item2; ?>" value="<?php echo $item2; ?>" <?php if($item2==$val): ?>checked<?php endif; ?>></label>
											<?php endforeach; endif; else: echo "" ;endif; ?>
										</div>
									</div>
									<?php endif; if($item['key']=='checkbox'): 
									$val = explode(',',$val);
									 ?>
									<div class="layui-form-item">
										<label class="layui-form-label"><?php echo $item['val1']; ?></label>
										<div class="layui-input-inline" style="min-width: 40%">
											<?php if(is_array($item['val2']) || $item['val2'] instanceof \think\Collection || $item['val2'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item['val2'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item2): $mod = ($i % 2 );++$i;?>
											<input type="checkbox" name="formdata[<?php echo $formkey; ?>][]" value="<?php echo $item2; ?>" title="<?php echo $item2; ?>" <?php if(in_array($item2,$val)): ?>checked<?php endif; ?>>
											<?php endforeach; endif; else: echo "" ;endif; ?>
										</div>
									</div>
									<?php endif; if($item['key']=='selector'): ?>
									<div class="layui-form-item">
										<label class="layui-form-label"><?php echo $item['val1']; ?></label>
										<div class="layui-input-inline">
											<select name="formdata[<?php echo $formkey; ?>]" class="layui-select">
												<option name="">请选择</option>
												<?php if(is_array($item['val2']) || $item['val2'] instanceof \think\Collection || $item['val2'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item['val2'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item2): $mod = ($i % 2 );++$i;?>
												<option name="formdata[<?php echo $formkey; ?>]" <?php if($item2==$val): ?>selected<?php endif; ?>><?php echo $item2; ?></option>
												<?php endforeach; endif; else: echo "" ;endif; ?>
											</select>
										</div>
									</div>
									<?php endif; if($item['key']=='time'): ?>
									<div class="layui-form-item">
										<label class="layui-form-label"><?php echo $item['val1']; ?></label>
										<div class="layui-input-inline">
											<input type="text" name="formdata[<?php echo $formkey; ?>]" id="<?php echo $formkey; ?>" class="layui-input timeinput" value="<?php echo $val; ?>">
										</div>
									</div>
									<?php endif; if($item['key']=='date'): ?>
									<div class="layui-form-item">
										<label class="layui-form-label"><?php echo $item['val1']; ?></label>
										<div class="layui-input-inline">
											<input type="text" name="formdata[<?php echo $formkey; ?>]" id="<?php echo $formkey; ?>" class="layui-input dateinput" value="<?php echo $val; ?>">
										</div>
									</div>
									<?php endif; if($item['key']=='upload'): ?>
									<div class="layui-form-item">
										<label class="layui-form-label"><?php echo $item['val1']; ?></label>
										<div class="layui-input-inline" style="min-width: 40%">
											<input type="hidden" name="formdata[<?php echo $formkey; ?>]" id="formpic<?php echo $formkey; ?>" class="layui-input" value="<?php echo $val; ?>">
											<button style="float:left;" type="button" class="layui-btn layui-btn-primary" upload-input="formpic<?php echo $formkey; ?>" upload-preview="formpic<?php echo $formkey; ?>Preview" onclick="uploader(this)">上传图片</button>
											<div id="formpic<?php echo $formkey; ?>Preview" style="float:left;padding-top:10px;clear: both;">
												<div class="layui-imgbox" style="width:100px;"><div class="layui-imgbox-img"><img src="<?php echo $val; ?>"/></div></div>
											</div>
										</div>
									</div>
									<?php endif; if($item['key'] == 'upload_file'): ?>
									<div class="layui-form-item">
										<label class="layui-form-label"><?php echo $item['val1']; ?></label>
										<div class="layui-input-inline">
											<input type="text" name="formdata[<?php echo $formkey; ?>]" id="formfile<?php echo $formkey; ?>" class="layui-input" value="<?php echo $val; ?>">
										</div>
										<div class="layui-input-inline">
											<button type="button" class="layui-btn layui-btn-primary" upload-input="formfile<?php echo $formkey; ?>" onclick="uploader(this)">上传文件</button>
										</div>
									</div>
									<?php endif; if($item['key']=='region'): ?>
									<div class="layui-form-item region_item" id="region<?php echo $customeKey; ?>" data-text="<?php echo $val; ?>">
										<label class="layui-form-label"><?php echo $item['val1']; ?></label>
										<div class="layui-input-inline custom_province_div" style="width: 150px">
											<select name="formdata[<?php echo $formkey; ?>][]" id="region<?php echo $customeKey; ?>_province" lay-filter="region<?php echo $customeKey; ?>_province"></select>
										</div>
										<div class="layui-input-inline custom_city_div" style="width: 150px">
											<select name="formdata[<?php echo $formkey; ?>][]" id="region<?php echo $customeKey; ?>_city" lay-filter="region<?php echo $customeKey; ?>_area"></select>
										</div>
										<div class="layui-input-inline custom_area_div" style="width: 150px" style="display:none">
											...
											<select name="formdata[<?php echo $formkey; ?>][]" id="region<?php echo $customeKey; ?>_area"></select>
										</div>
									</div>
									<?php endif; ?>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								...
								<div class="layui-tab-item">
									<?php if($setcontent): foreach($setcontent as $k=>$field): ?>
										<div class="layui-form-item">
											<?php if($field['key']=='separate'): ?>
											<label class="layui-form-label" style="font-size: 16px;font-weight: bold"><?php echo $field['val1']; ?></label>
											<?php else: ?>
											<label class="layui-form-label"><?php if($field['val3']==1): ?><span class="redstar">*</span><?php endif; ?><?php echo $field['val1']; ?>：</label>
											<?php endif; if($field['key'] == 'input'): ?>
											<div class="layui-input-inline">
										<!-- 		<input type="text" name="set[form<?php echo $k; ?>]" value="<?php echo $log['form'.$k]; ?>" class="layui-input" <?php if($field['val4'] == 1): ?> lay-verify="number" <?php elseif($field['val4'] == 2): ?> lay-verify="phone" <?php elseif($field['val4'] == 3): ?> lay-verify="identity" <?php elseif($field['val4'] == 4): ?> lay-verify="email" <?php endif; ?>> -->
												<?php if($field['val4'] == 1): ?>
													<input type="number" name="set[form<?php echo $k; ?>]" value="<?php echo $log['form'.$k]; ?>" class="layui-input">
												<?php else: ?>
													<input type="text" name="set[form<?php echo $k; ?>]" value="<?php echo $log['form'.$k]; ?>" class="layui-input" <?php if($field['val4'] == 2): ?> lay-verify="phone" <?php elseif($field['val4'] == 3): ?> lay-verify="identity" <?php elseif($field['val4'] == 4): ?> lay-verify="email" <?php endif; ?>>
												<?php endif; ?>
											</div>
											<?php endif; if($field['key'] == 'textarea'): ?>
											<div class="layui-input-inline">
												<textarea type="text" name="set[form<?php echo $k; ?>]" class="layui-textarea"><?php echo $log['form'.$k]; ?></textarea>
											</div>
											<?php endif; if($field['key'] == 'radio'): ?>
											<div class="layui-input-inline" style="width:500px">
												<?php foreach($field['val2'] as $k2=>$v2): ?>
												<input type="radio" name="set[form<?php echo $k; ?>]" value="<?php echo $v2; ?>" title="<?php echo $v2; ?>" <?php if($log['form'.$k] && $log['form'.$k] == $v2): ?>checked<?php endif; ?> />
												<?php endforeach; ?>
											</div>
											<?php endif; if($field['key'] == 'checkbox'): ?>
											<div class="layui-input-inline" style="width:500px">
												<?php foreach($field['val2'] as $k2=>$v2): ?>
												<input type="checkbox" name="set[form<?php echo $k; ?>]" value="<?php echo $v2; ?>" title="<?php echo $v2; ?>" <?php if($log['form'.$k] && in_array($v2,explode(',',$log['form'.$k]))): ?>checked<?php endif; ?> />
												<?php endforeach; ?>
											</div>
											<?php endif; if($field['key'] == 'selector'): ?>
											<div class="layui-input-inline">
												<select name="set[form<?php echo $k; ?>]">
													<option value="">请选择</option>
													<?php foreach($field['val2'] as $k2=>$v2): ?>
													<option value="<?php echo $v2; ?>" <?php if($log['form'.$k] && $log['form'.$k] == $v2): ?>selected<?php endif; ?>><?php echo $v2; ?></option>
													<?php endforeach; ?>
												</select>
											</div>
											<?php endif; if($field['key'] == 'time'): ?>
											<div class="layui-input-inline">
												<input type="text" name="set[form<?php echo $k; ?>]" value="<?php echo $log['form'.$k]; ?>" class="layui-input" id="set<?php echo $k; ?>"/>
											</div>
											<?php endif; if($field['key'] == 'date'): ?>
											<div class="layui-input-inline">
												<input type="text" name="set[form<?php echo $k; ?>]" value="<?php echo $log['form'.$k]; ?>" class="layui-input" id="set<?php echo $k; ?>"/>
											</div>
											<?php endif; if($field['key'] == 'region'): ?>
											<div class="layui-input-inline">
												<select name="set[form<?php echo $k; ?>][]" id="set<?php echo $k; ?>_province" lay-filter="set<?php echo $k; ?>_province"></select>
											</div>
											<div class="layui-input-inline">
												<select name="set[form<?php echo $k; ?>][]" id="set<?php echo $k; ?>_city" lay-filter="set<?php echo $k; ?>_city"></select>
											</div>
											<div class="layui-input-inline">
												<select name="set[form<?php echo $k; ?>][]" id="set<?php echo $k; ?>_area" ></select>
											</div>
											<?php endif; if($field['key'] == 'upload'): ?>
											<input type="hidden" name="set[form<?php echo $k; ?>]" id="form<?php echo $k; ?>" class="layui-input" value="<?php echo $log['form'.$k]; ?>">
											<button style="float:left;" type="button" class="layui-btn layui-btn-primary" upload-input="form<?php echo $k; ?>" upload-preview="form<?php echo $k; ?>Preview" onclick="uploader(this)">上传图片</button>
											<div id="form<?php echo $k; ?>Preview" class="picsList-class-padding">
												<div class="layui-imgbox" style="width:100px;"><div class="layui-imgbox-img"><img src="<?php echo $log['form'.$k]; ?>"/></div></div>
											</div>
											<?php endif; if($field['key'] == 'upload_file'): ?>
											<div class="layui-input-inline" style="width: auto">
												<button class="layui-btn layui-btn-primary" type="button" class="layui-input" id="set<?php echo $k; ?>">上传文件</button>
												<input type="hidden" name="set[form<?php echo $k; ?>]" value="<?php echo $log['form'.$k]; ?>" class="layui-input" id="input_set<?php echo $k; ?>"/>
											</div>
											<div class="layui-form-mid layui-word-aux" id="input_name_set<?php echo $k; ?>"><?php echo $log['form'.$k]; ?></div>
											<?php endif; ?>
										</div>
									<?php endforeach; ?>
									<?php endif; ?>
								</div>
								<?php endif; if(getcustom('member_richinfo')): ?>
								<div class="layui-tab-item">
									<!-- 详情编辑器 -->
									<?php 
									$pagetitle='详细介绍';
...
function geteditordata() {
	...
	return $scope.getdata()
								...
								<?php endif; if(getcustom('member_change_mendian')): ?>
								<div class="layui-form-item">
									<label class="layui-form-label"><?php echo t('门店'); ?>ID</label>
									<div class="layui-input-inline">
										<input type="text" name="info[mdid]" class="layui-input mdid" value="<?php echo $info['mdid']; ?>">
									</div>
									<a href="javascript:vodi(0)" class="layui-btn layui-btn-primary" onclick="chooseMendianShow()">查找<?php echo t('门店'); ?></a>
								</div>
								<?php endif; ?>
  ...
  <?php if(!getcustom('member_richinfo')): ?>
	<script type="text/javascript" src="/static/admin/layui/layui.all.js?v=20210226"></script>
<script type="text/javascript" src="/static/admin/layui/lay/modules/flow.js?v=1"></script>
<script type="text/javascript" src="/static/admin/layui/lay/modules/formSelects-v4.js"></script>
<script type="text/javascript" src="/static/admin/js/jquery-ui.min.js?v=20200228"></script>
...
<script>
	...
	var areaAlert = true,
		provinceIndex = 0,
		cityIndex = 0,
		dataInfo = <?php echo $area_agent_info; ?>,
		indexInfo = [];
	...
	var levelArr = <?php echo jsonEncode($levelArr); ?>;
	var defaultlevelid = "<?php echo $defaultlevel['id']; ?>";
	...
	address3('areafenhong_province','areafenhong_city','areafenhong_area',"<?php echo $info['areafenhong_province']; ?>","<?php echo $info['areafenhong_city']; ?>","<?php echo $info['areafenhong_area']; ?>");
	<?php if(getcustom('plug_sanyang')): if(!$levelExtendList): ?>
	address3('areafenhong_province_0','areafenhong_city_0','areafenhong_area_0',"","","");
	<?php endif; foreach($levelExtendList as $levelExtend): ?>
	address3('areafenhong_province_<?php echo $levelExtend['id']; ?>','areafenhong_city_<?php echo $levelExtend['id']; ?>','areafenhong_area_<?php echo $levelExtend['id']; ?>',"<?php echo $levelExtend['areafenhong_province']; ?>","<?php echo $levelExtend['areafenhong_city']; ?>","<?php echo $levelExtend['areafenhong_area']; ?>");
	<?php endforeach; ?>
	<?php endif; if($register_record): ?>
  ...
  <?php if(getcustom('member_set')): foreach($setcontent as $k=>$field): if($field['key'] == 'time'): ?>
			layui.laydate.render({ 
				elem: '#set<?php echo $k; ?>'
				,type: 'time'
				,format:'HH:mm'
		...
		<?php endif; if($field['key'] == 'upload_file'): ?>
			upload.render({
				...
				,done: function(res){
					if(res.status == 1){
						$("#input_set<?php echo $k; ?>").val(res.url);
						$("#input_name_set<?php echo $k; ?>").text(res.url);
					}else{
		...
		<?php endif; if($field['key'] == 'region'): 
			 ...
			 ?>
			address3('set<?php echo $k; ?>_province','set<?php echo $k; ?>_city','set<?php echo $k; ?>_area',"<?php echo $setdata[0]; ?>","<?php echo $setdata[1]; ?>","<?php echo $setdata[2]; ?>");
		<?php endif; ?>
	<?php endforeach; ?>
  <?php endif; if(getcustom('wurl_reward')): ?>
  ...
  <?php endif; ?>
	layui.form.on('submit(member_edit)', function(obj){
		...
		<?php if(getcustom('member_area_agent_multi')): ?>field.areadata = dataInfo;<?php endif; if(getcustom('member_richinfo')): ?>field['info[richinfo]'] = geteditordata();<?php endif; ?>
		var index = layer.load();
	  ...
	  <?php if(getcustom('score_to_money_auto')): ?>
    ...
    function chooseMendianShow(obj){
        mobj = obj;
        selectmemberLayer = layer.open({type:2,title:'选择<?php echo t('门店'); ?>',content:"<?php echo url('Mendian/choosemendian'); ?>",area:['1000px','600px'],shadeClose:true});
    }
