<?php /*a:3:{s:67:"/www/wwwroot/gdqshop.cn/app/view/barcode_inventory/dealer_edit.html";i:1768722663;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-card layui-col-md12">
                <div class="layui-card-header">
                    <i class="fa fa-building"></i> <?php echo $title; ?>
                ...
                <div class="layui-card-body" pad15>
                    <div class="form-container">
                        <form class="layui-form" action="" method="post" id="dealerForm">
                            <!-- 经销商ID -->
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label"><span class="redstar">*</span><?php echo t('经销商名称'); ?>：</label>
                                <div class="layui-input-block">
                                    <input type="text" name="dealer_name" id="dealer_name" placeholder="<?php echo t('请输入经销商名称'); ?>" 
                                           class="layui-input" required value="<?php echo (isset($info['dealer_name']) && ($info['dealer_name'] !== '')?$info['dealer_name']:''); ?>">
                                </div>
                            </div>
                            
                            <!-- 负责人 -->
                            <div class="layui-form-item">
                                <label class="layui-form-label"><span class="redstar">*</span><?php echo t('负责人'); ?>：</label>
                                <div class="layui-input-block">
                                    <input type="text" name="contact_person" id="contact_person" placeholder="<?php echo t('请输入负责人'); ?>" 
                                           class="layui-input" required value="<?php echo (isset($info['contact_person']) && ($info['contact_person'] !== '')?$info['contact_person']:''); ?>">
                                </div>
                            </div>
                            
                            <!-- 联系电话 -->
                            <div class="layui-form-item">
                                <label class="layui-form-label"><span class="redstar">*</span><?php echo t('联系电话'); ?>：</label>
                                <div class="layui-input-block">
                                    <input type="text" name="phone" id="phone" placeholder="<?php echo t('请输入联系电话'); ?>" 
                                           class="layui-input" required value="<?php echo (isset($info['phone']) && ($info['phone'] !== '')?$info['phone']:''); ?>">
                                </div>
                            </div>
                            
                            <!-- 经营地址 -->
                            <div class="layui-form-item">
                                <label class="layui-form-label"><span class="redstar">*</span><?php echo t('经营地址'); ?>：</label>
                                <div class="layui-input-block">
                                    <input type="text" name="address" id="address" placeholder="<?php echo t('请输入经营地址'); ?>" 
                                           class="layui-input" required value="<?php echo (isset($info['address']) && ($info['address'] !== '')?$info['address']:''); ?>">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                <div class="layui-input-block">
                                    <button class="layui-btn" type="submit" lay-submit lay-filter="dealerSubmit">
                                        <i class="fa fa-check"></i> <?php echo t('提交'); ?>
                                    </button>
                                    <button class="layui-btn layui-btn-primary" type="button" onclick="window.location.href='/?s=/BarcodeInventory/dealer_list'">
                                        <i class="fa fa-arrow-left"></i> <?php echo t('返回'); ?>
                                    </button>
                                </div>
                            </div>
                        </form>
...
<script>
    ...
    <script>
        layui.use(['form', 'layer'], function() {
            ...
            // 表单提交
            form.on('submit(dealerSubmit)', function(data) {
                // 显示加载中
                var loadingIndex = layer.load(2);
                
                $.ajax({
                    url: '<?php echo isset($info['id']) ? url("BarcodeInventory/edit_dealer") : url("BarcodeInventory/add_dealer"); ?>',
                    type: 'POST',
                    data: data.field,
                    dataType: 'json',
                    success: function(res) {
                        ...
                        if (res.status == 1) {
                            layer.msg(res.msg, {icon: 1, time: 1500}, function() {
                                window.location.href = '/?s=/BarcodeInventory/dealer_list';
                            });
                        } else {
