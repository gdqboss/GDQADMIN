<?php /*a:4:{s:56:"/www/wwwroot/gdqshop.cn/app/view/backstage/welcome2.html";i:1769504607;s:48:"/www/wwwroot/gdqshop.cn/app/view/public/css.html";i:1747926690;s:47:"/www/wwwroot/gdqshop.cn/app/view/public/js.html";i:1747926690;s:54:"/www/wwwroot/gdqshop.cn/app/view/public/copyright.html";i:1747926690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-card layui-col-md12">
			<div class="layui-card-body" pad15>
				 <div style="padding:20px 10px;font-size:16px"><?php echo session('ADMIN_NAME'); ?>，欢迎光临！</div>
				 <div style="padding:0px 10px 20px 10px;">
					<div style="margin-bottom:10px;">
						<span style="display:inline-block;width:80px;">姓名：</span>
						<span><?php echo (isset($user_info['name']) && ($user_info['name'] !== '')?$user_info['name']:'未设置'); ?></span>
					</div>
					<div style="margin-bottom:10px;">
						<span style="display:inline-block;width:80px;">关联供应商：</span>
						<span>
					...
					<div style="margin-bottom:10px;">
						<span style="display:inline-block;width:80px;">身份：</span>
						<span><?php echo (isset($user_info['identity']) && ($user_info['identity'] !== '')?$user_info['identity']:'未设置'); ?></span>
					</div>
				</div>
			</div>
      </div>
