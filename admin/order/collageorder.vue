					...
					<view class="head">
						...
						<block v-if="item.status==1">
							<block v-if="item.buytype!=1">
								...
								<text v-if="item.team.status==2 && item.freight_type!=1 && item.order_pay_type==1" class="st1">拼团成功,待发货</text>
								<text v-if="item.team.status==2 && item.freight_type==1 && item.order_pay_type==1" class="st1">拼团成功,待提货</text>
