...
<!--				</view>-->
				<view class="form-item">
					...
					<view class="f2"><input type="text" name="limit_fee" :value="info.limit_fee" placeholder="" placeholder-style="color:#888"></input></view>
				</view>
				<view class="form-item">
					<view class="f1">预定费</view>
					<view class="f2"><input type="text" name="booking_fee" :value="info.booking_fee" placeholder="" placeholder-style="color:#888"></input></view>
				</view>
				<view class="form-item">
					<view class="f1">座位数</view>
					<view class="f2"><input type="text" name="seat" :value="info.seat" placeholder="" placeholder-style="color:#888"></input></view>
				</view>
